// Daniel Harvey
// combining Adafruit_TSL2561.h (by K. Townsend) and Adafruit_HTU21DF.h (by Limor Fried/Ladyada) using SoftI2CMaster.h (by Tod E. Kurt) instead of Wire.h
...
class Adafruit_HTU21DF {
 public:
  Adafruit_HTU21DF();
  Adafruit_HTU21DF(uint8_t sda, uint8_t scl);
  boolean begin(void);
...
class Adafruit_TSL2561 {
 public:
  Adafruit_TSL2561();
  Adafruit_TSL2561(uint8_t sda, uint8_t scl, uint8_t addr, int32_t sensorID = -1);
  boolean begin(void);
